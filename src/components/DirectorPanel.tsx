  ...
  const handleSaveProduct = (e: React.FormEvent) => {
    ...
    if (editingProduct) {
      ...
      const newProd: Product = {
        ...
        precoVenda: priceNum,
        custoUnitario: custoNum,
        category: productForm.category || 'divertidas',
        imageUrl:
                  ...
                  <form onSubmit={handleSaveProduct} className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="camisetas">Camisetas Seu José</option>
                        <option value="combos">Combos & Kits</option>
                        <option value="invisivel">Cano Curto / Invisível</option>
