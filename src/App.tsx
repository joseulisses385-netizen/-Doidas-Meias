...
import { MarketplaceChannelsStrip } from './components/MarketplaceChannelsStrip';
...
const STORAGE_KEYS = {
  PRODUCTS: 'doidas_meias_products_v4',
  SETTINGS: 'doidas_meias_settings_v4',
  CART: 'doidas_meias_cart_v2',
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#190224] text-white selection:bg-[#ff007f] selection:text-white">
      ...
      <main className="flex-1">
        ...
        {/* Marketplace Omnichannel Channels Strip (TikTok, Instagram, WhatsApp, Loja) */}
        <MarketplaceChannelsStrip settings={settings} />
        ...
        {/* Seção Completa de Garantias de Segurança, SSL & Proteção ao Consumidor */}
